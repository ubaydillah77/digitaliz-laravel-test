        ...
        <form action='/materials/{{ $material->id }}' method="POST">
            ...
            <div class="mb-5">
                <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                    Title</label>
                <input type="title" id="title" name="title" value="{{ $material->title }}"
            ...
            <div class="mb-5">
                <label for="embed_link" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                    embed_link</label>
                <input type="embed_link" id="embed_link" name="embed_link" value="{{ $material->embed_link }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                @error('duration')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-5">
                <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                    Description</label>
                <textarea class="border w-full p-2" rows="4" name="description">
